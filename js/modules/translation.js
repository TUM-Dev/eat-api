...
const resources = {
    en: {
        translation: {
            ...
            "date": "{{date, datetime(weekday: long; year: numeric; month: long; day: numeric)}}",
            "no-further-menu": "There is no further menu available",
            "location-invalid": "A location with the id {{location}} does not exist.",
            "closest-canteen": "Select closest canteen",
            "show-map": "Show map with all canteens",
            "opened": "{{date, datetime(weekday: long)}} opened from {{start}} to {{end}}",
            "mon": "Monday",
            "tue": "Tuesday",
            "wed": "Wednesday",
            "thu": "Thursday",
            ...
            "opening-hours-0": "The selected date is not today",
            "opening-hours-1": "Canteen will open later today",
            "opening-hours-2": "Canteen is currently open",
            "opening-hours-3": "Canteen is already closed",
            "show-opening-hours": "Show the opening hours",
    ...
    de: {
        translation: {
            ...
            "date": "{{date, datetime(weekday: long; year: numeric; month: long; day: numeric)}}",
            "no-further-menu": "Es ist kein weiteres Menü verfügbar",
            "location-invalid": "Es gibt keine Mensa mit der ID {{location}}",
            "closest-canteen": "Nächstgelegene Mensa auswählen",
            "show-map": "Zeige Karte mit allen Mensen",
            "opened": "{{date, datetime(weekday: long)}} geöffnet von {{start}} bis {{end}}",
            "mon": "Montag",
            "tue": "Dienstag",
            "wed": "Mittwoch",
            "thu": "Donnerstag",
            ...
            "opening-hours-0": "Das ausgewählte Datum ist nicht heute",
            "opening-hours-1": "Die Mensa wird später öffnen",
            "opening-hours-2": "Die Mensa ist aktuell geöffnet",
            "opening-hours-3": "Die Mensa hat bereits geschlossen",
            "show-opening-hours": "Zeige die Öffnungszeiten",
